...
const TopPlay = () => {
  ...
  return (
    <div className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[450px] max-w-full flex flex-col" ref={divRef}>
        ...
        <Swiper
          ...
          {topPlays?.map((artist, i) =>{
           return <SwiperSlide
              ...
              <Link to={`/artists/${artist?.artists ? artist?.artists[0]?.adamid : 'nothing'}`}>
